      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `PARTNERSHIPS`,
            subtitle: `OUR GLOBAL PARTNERS INCLUDE`,
              description: `Companies around the world we have worked with to make our training center stand out and be the forefront in education.`,
            }}
          />
